...
- [a toy example illustrating a perfect LD setting and an independent setting](https://github.com/yuanzhongshang/sdSuSiE/blob/main/reproduce/simulation/simulation_toy_example.sh)
