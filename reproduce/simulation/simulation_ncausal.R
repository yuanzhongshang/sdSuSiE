...
i=1
rm(select_cd)
select_cd=sort(sample(c(1:dim(LD_M)[1]),n_causal[i]))
beta_c=rep(0,dim(LD_M)[1])
beta_d=rep(0,dim(LD_M)[1])

beta_shared<-rmvnorm(length(select_cd),mean=rep(0,2),sigma=matrix(c(h_c,rho*sqrt(h_d*h_c),rho*sqrt(h_d*h_c),h_d)/n_causal[i],ncol=2,nrow=2))
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i]))
dir.create("causal")
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/causal/data_",rep,".RData"))
...
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/sd/data_",rep,".RData"))
...
dir.create("stepwise")
write.table(res,paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/stepwise/res_",rep,".txt"), quote=FALSE, row.names=FALSE)
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/susie"))
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i]))
dir.create("susieadd")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/susieadd"))
dir.create("susieresult")
dir.create("susiePIP")
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i]))
dir.create("mesusie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/mesusie"))
...
sdp <- 2 * exp(log_p_value)
sdr=data.frame(snp,sdp)
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/mesusie/data_",rep,".RData"))

#SharePro_gxe
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i]))
dir.create("sharepro05")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/baseline/",n_causal[i],"/sharepro05"))
