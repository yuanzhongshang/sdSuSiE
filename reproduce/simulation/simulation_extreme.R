...
dir.create("causal")
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/co/causal/data_",rep,".RData"))
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/co/susie"))
...
dir.create("causal")
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/onlyinter/causal/data_",rep,".RData"))
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/onlyinter/susie"))
dir.create("susieresult")
dir.create("susieresultL_10")
dir.create("susiePIP")
...
dir.create("causal")
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/sexsp/causal/data_",rep,".RData"))
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/sexsp/susie"))
dir.create("susieresult")
dir.create("susieresultL_10")
dir.create("susiePIP")
...
rm(select_cd)
select=sort(sample(c(1:dim(LD_M)[1]),n_causal+1))
select_cd=select[1]
select_c=select[2]
beta_c=rep(0,dim(LD_M)[1])
beta_d=rep(0,dim(LD_M)[1])
...
beta_c[select_cd]=beta_shared[,1]
beta_d[select_cd]<-beta_shared[,2]
beta_c[select_c]=rnorm(length(select_c),0,sqrt(h_c))

M_marginal<-LD_M%*%(beta_c-beta_d)
F_marginal<-LD_F%*%(beta_c+beta_d)

y_null_M<-rnorm(ref_N_M,0,sqrt(1-h_c*2-h_d))
err_beta_M<-t(ref_M_spe)%*%y_null_M/ref_N_M
y_null_F<-rnorm(ref_N_F,0,sqrt(1-h_c*2-h_d))
err_beta_F<-t(ref_F_spe)%*%y_null_F/ref_N_F
...
dir.create("causal")
save(select_c,select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/bothco/causal/data_",rep,".RData"))
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/bothco/susie"))
dir.create("susieresult")
dir.create("susieresultL_10")
dir.create("susiePIP")
...
beta_c[select_cd]=beta_shared[,1]
beta_d[select_cd]<-beta_shared[,2]
beta_d[select_d]=rnorm(length(select_d),0,sqrt(h_c))
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/extreme/bothsd/susie"))
dir.create("susieresult")
dir.create("susieresultL_10")
dir.create("susiePIP")
