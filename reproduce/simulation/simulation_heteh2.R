...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i]))
dir.create("causal")
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/causal/data_",rep,".RData"))
...
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/sd/data_",rep,".RData"))
...
dir.create("stepwise")
write.table(res,paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/stepwise/res_",rep,".txt"), quote=FALSE, row.names=FALSE)
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/susie"))
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i]))
dir.create("susieadd")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/susieadd"))
dir.create("susieresult")
dir.create("susiePIP")
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i]))
dir.create("mesusie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/mesusie"))
...
sdp <- 2 * exp(log_p_value)
sdr=data.frame(snp,sdp)
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/mesusie/data_",rep,".RData"))

#SharePro_gxe
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i]))
dir.create("sharepro05")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/hetehe/",h_c[i],"/sharepro05"))
