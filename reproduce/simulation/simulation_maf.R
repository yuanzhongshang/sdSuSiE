...
#load the file including maf information
maf=fread(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex/ref/total/chr_",chr,".frq"))
...
dir.create("causal")
snp=sub("_[^_]*$", "", colnames(ref_F_spe))
select_cd=which.min(abs(maf$MAF[match(snp,maf$SNP)]-maf[i]))
save(select_cd,file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/causal/data_",rep,".RData"))
...
err_beta_F_scale<-sqrt(ref_N_F/N_F[i])*err_beta_F
      
z_M<-(M_marginal+err_beta_M_scale)*sqrt(N_M)
z_F<-(F_marginal+err_beta_F_scale)*sqrt(N_F[i])  
...
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/sd/data_",rep,".RData"))
...
dir.create("stepwise")
write.table(res,paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/stepwise/res_",rep,".txt"), quote=FALSE, row.names=FALSE)
...
dir.create("susie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/susie"))
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf",maf[i]))
dir.create("susieadd")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/susieadd"))
dir.create("susieresult")
dir.create("susiePIP")
...
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i]))
dir.create("mesusie")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/mesusie"))
...
sdp <- 2 * exp(log_p_value)
sdr=data.frame(snp,sdp)
save(sdr, file = paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf/",maf[i],"/mesusie/data_",rep,".RData"))

#SharePro_gxe
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf",maf[i]))
dir.create("sharepro05")
setwd(paste0("/net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsexsimulation/lowmaf",maf[i],"/sharepro05"))
