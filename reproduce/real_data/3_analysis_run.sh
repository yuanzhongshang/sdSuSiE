...
echo "value is: $value"
cp -r /net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex5e_8/49_irnt/3_analysis.sh /net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex5e_8/$value/
cp -r /net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex5e_8/49_irnt/3_analysis.R /net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex5e_8/$value/
cd /net/mulan/disk2/luliuu/project4/realdata/Gtex/GWASsex5e_8/$value/
sed -i "s/49_irnt/$value/g" 3_analysis.sh
